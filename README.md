...
Using the Luhn Algorithm , also known as "modulus 10", I will be determining the validity of a given credit card number.
...
As requested, it should have three main properties set on  - card_number, card_type, and valid.
...
There are three instance methods. We may perform these methods in the order you see fit.
...
Discover must start with 3, or 6011 
